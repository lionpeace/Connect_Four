...
// TO MAKE CHANGES INSIDE THE MATRIX
void change_matrix(int *matrix, int *starter, int *row_choice);

// TO CHANGE USER'S ORDER
void change_order(int *five, int *four, int *matrix);

// TO CHECK THE MATRIX HORIZONTALLY FOR DETERMINING WINNER
void horizontal_check_matrix(int *matrix, int *win_check, int *starter);

// TO CHECK THE MATRIX VERTICALLY FOR DETERMINING WINNER
void vertical_check_matrix(int *matrix, int *win_check, int *starter);

// TO CHECK THE MATRIX FOR DETERMINING WINNER
...
int main() {
    ...
    do
    {
        ...
        if (starter == 4)
        {
            ...
            change_order(p_four, p_five, p_matrix);
        ...
        else if(starter == 5)
        {
            ...
            change_order(p_five, p_four, p_matrix);
...
void change_order(int *five, int *four, int *matrix) {
    ...
    for(i = 0; i <= 6; i++)
    {
        if((*(matrix + i) != 0))
        {
            cout << "The row you chose is full. The order changed.";
            cout << endl << endl;
            temp = *four;
            *four = *five;
            *five = temp;
